...
- `src/worker/embedded_r.rs`, `src/worker/embedded_r/parse.rs`, `src/r_repl.c` — R runtime, complete-cell parsing, interrupt state and deferral, native event-aware waiting, graphics, console source routing, and the C-owned DLL-REPL boundary.
