...
Named sessions, restart with new requirements, runtime R requirement additions, SQL relation bridges, the sidecar API, viewer, output retention, and transcript generation do not exist yet.
