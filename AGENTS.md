...
- `src/python/requirements.rs` — passive native storage of the current managed requirement object, preserving its R representation behind the existing active binding.
