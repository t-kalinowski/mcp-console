...
- `src/transcript.rs`, `src/transcript/markdown.rs`, `src/transcript/output.rs` — append-only tool journal, Markdown and source-only Quarto projections, cell output files, and image artifacts.
