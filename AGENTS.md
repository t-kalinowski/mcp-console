...
Named sessions, restart with new requirements, runtime R requirement additions, SQL relation bridges, the sidecar API, viewer, complete output retention, and generated Quarto transcripts do not exist yet.
