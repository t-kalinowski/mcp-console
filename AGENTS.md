...
- `src/worker_client/output.rs`, `src/worker_client/output/{tape,preview,terminal}.rs` — canonical response composition, streaming output cuts, bounded head-and-tail collection, independent image admission, raw-file receipts, and progress projection.
