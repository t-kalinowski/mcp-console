...
Do not include internal facts that do not change agent behavior: Ark, Jupyter, `harp`, `libr`, DBI, worker IPC, stack-frame implementation, the internal JSONL journal, or exact output limits.
