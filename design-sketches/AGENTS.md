...
- `CONFIGURATION.md` — exploratory, aspirational `.mcp-console/config.yaml` design spike covering profiles, permissions, execution targets, environments, and policy layering; implementation PRs refine the contract.
