...
For SSH transport, `target.lease_ms` sets each channel's controller lease in integer milliseconds, from 1,000 through 300,000 (default 30,000).
Local host and Docker targets reject this setting.
