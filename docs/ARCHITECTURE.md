...
CPython core initialization disables automatic site processing with `Py_NoSiteFlag`; Console connects streams, managed input, and interrupt delivery before calling `site.main()` through its ordinary Python exception boundary.
