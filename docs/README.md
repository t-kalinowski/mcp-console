...
- [macOS sandbox supervision](SANDBOX_SUPERVISION.md) describes normal observed-descendant retirement, committed crash ownership, and the remaining post-spawn boundary.
