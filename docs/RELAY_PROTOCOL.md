...
From readiness onward, the manager is the sole directory-cleanup owner; a manager failure leaves the private directory in place.
...
The private directory remains in place because the server relinquished its guard at readiness.
