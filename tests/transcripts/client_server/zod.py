...
from _zod.processes import (
    build_killpg_denial_interposer,
...
from _zod.response_gating import (
...
def test_replaces_worker_after_relay_exit(binary: Path) -> Transcript:
    ...
    with tempfile.TemporaryDirectory() as temporary_directory:
        ...
        try:
            ...
            wait_for_marker(temporary_path, killpg_count.name, client)
            client.send()
