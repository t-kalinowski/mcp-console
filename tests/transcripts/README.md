...
The restart case keeps the old generation's capture descriptor open across sandbox cleanup and records the observed worker-stdin EOF alongside the sideband shutdown frame.
